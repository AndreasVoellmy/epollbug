/*
This program experiments with registering each socket on each worker's kqueue.
 */
...
// (4) Compile with: gcc -O2 kqueueserver5.c -lpthread -Wall -o kqueueserver5
// (5) To run: ./kqueueserver5
